...
public class TuitionFees_old extends Activity {
	...
	private void showAlertDialog() {
		AlertDialog.Builder builder = new AlertDialog.Builder(TuitionFees_old.this);
	...
	private void getDocument(String documentURL) {
		...
		final AsyncTask<String, Void, Boolean> backgroundTask = new AsyncTask<String, Void, Boolean>() {
			...
			protected void onPostExecute(Boolean status) {
				...
				if (status == false) {
					Utils.showLongCenteredToast(TuitionFees_old.this,
							TuitionFees_old.this.getString(R.string.tumonline_settings_error));
				}
			}
		};
